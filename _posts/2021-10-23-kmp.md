...
<span style='background-color: #dcffe4'>KMP(Knuth-Morris-Pratt) algorithm is that remove the unnecessary search process when search for a string.</span> 
...
(3) Overlapping prefixes and suffixes
